...
export default function FileWalkthrough({ files, aiProvider, commits, prHtmlUrl }) {
    ...
    <div className="walkthrough">
      ...
      {commits?.length > 0 && (
        <section className="commits-section">
          <h4>Commits</h4>
          <CommitTimeline commits={commits} htmlUrl={prHtmlUrl} />
        </section>
      )}

      <h4 className="walkthrough-files-heading">Changed files</h4>
